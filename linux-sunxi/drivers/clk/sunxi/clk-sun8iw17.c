...
static const char *cpurvm_parents[] = {"losc", "hosc"};
...
SUNXI_CLK_PERIPH(tve,            TVE_CFG,         24,      3,            TVE_CFG,            0,         4,          8,          2,          0,          TVE_CFG,         TVE_GATE,        TVE_GATE,      0,             31,         16,         0,              0,             &clk_lock, NULL,             0);
SUNXI_CLK_PERIPH(tvd0,           TVD0_CFG,        24,      3,            TVD0_CFG,           0,         4,          8,          2,          0,          TVD0_CFG,        TVD_GATE,        TVD_GATE,      MBUS_GATE,     31,         16,         0,              7,             &clk_lock, &com_gates[3],    0);
SUNXI_CLK_PERIPH(tvd1,           TVD1_CFG,        24,      3,            TVD1_CFG,           0,         4,          8,          2,          0,          TVD1_CFG,        TVD_GATE,        TVD_GATE,      MBUS_GATE,     31,         17,         1,              7,             &clk_lock, &com_gates[3],    1);
SUNXI_CLK_PERIPH(tvd2,           TVD2_CFG,        24,      3,            TVD2_CFG,           0,         4,          8,          2,          0,          TVD2_CFG,        TVD_GATE,        TVD_GATE,      MBUS_GATE,     31,         18,         2,              7,             &clk_lock, &com_gates[3],    2);
SUNXI_CLK_PERIPH(tvd3,           TVD3_CFG,        24,      3,            TVD3_CFG,           0,         4,          8,          2,          0,          TVD3_CFG,        TVD_GATE,        TVD_GATE,      MBUS_GATE,     31,         19,         3,              7,             &clk_lock, &com_gates[3],    3);
...
SUNXI_CLK_PERIPH(cpurvm,         CPUS_VM_CFG,     24,      1,            CPUS_VM_CFG,        0,         5,          8,          2,          0,          CPUS_VM_CFG,     CPUS_VM_GATE,    CPUS_VM_GATE,  0,             31,         16,         0,              0,             &clk_lock, NULL,             0);
...
struct periph_init_data sunxi_periphs_cpus_init[] = {
	...
	{"cpurvm",          0,                                  cpurvm_parents,         ARRAY_SIZE(cpurvm_parents),         &sunxi_clk_periph_cpurvm        },
	{"cpurths",         0,                                  apbs1mod_parents,       ARRAY_SIZE(apbs1mod_parents),       &sunxi_clk_periph_cpurths       },
