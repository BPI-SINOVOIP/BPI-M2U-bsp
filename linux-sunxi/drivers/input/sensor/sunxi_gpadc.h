...
struct sunxi_gpadc {
	...
	struct input_dev *input_gpadc;
	struct input_dev *input_electricity;
	struct input_dev *input_sensor;
	struct clk *mclk;
	struct clk *pclk;
	void __iomem *reg_base;
	int irq_num;
	u32 channel_num;
	u32 channel[CHANNEL_MAX_NUM];
	u32 scankeycodes[KEY_MAX_CNT];
	u32 channel_compare[CHANNEL_MAX_NUM];
