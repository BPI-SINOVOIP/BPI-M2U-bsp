...
/* config DMA */
void sunxi_hcd_dma_set_config(struct sunxi_hcd_qh *qh,
...
/* start DMA */
void sunxi_hcd_dma_start(struct sunxi_hcd_qh *qh,
		__u32 fifo, __u32 buffer, __u32 len)
{
}
...
#if 0
static __u32 sunxi_hcd_dma_left_length(struct sunxi_hcd_qh *qh,
		__u32 is_in, __u32 buffer_addr)
{
	return 0;
}

__u32 sunxi_hcd_dma_transmit_length(struct sunxi_hcd_qh *qh,
		__u32 is_in, __u32 buffer_addr)
{
	return 0;
}
