...
#ifndef _PM_CONFIG_SUN8IW17P1_H
#define _PM_CONFIG_SUN8IW17P1_H
 ...
 **/
#define SP_IN_SRAM		0xf002bff0	/*end of 16k */
#define SP_IN_SRAM_PA		0x0002bff0	/*end of 16k */
#define SP_IN_SRAM_START	(SRAM_FUNC_START_PA | 0x3c00)	/*15k */
#endif /*_PM_CONFIG_SUN8IW17P1_H*/
