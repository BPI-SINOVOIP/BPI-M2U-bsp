...
static const unsigned int sun3iw1_disp_num_layers[] = {
	/* DISP_SCREEN0 */
	4,
};

static const unsigned int sun3iw1_disp_supported_output_types[] = {
	/* DISP_SCREEN0 */
	1,
};

static const enum __disp_layer_feat sun3iw1_disp_layer_feats[] = {
	/* DISP_SCREEN0 */
	DISP_LAYER_FEAT_GLOBAL_ALPHA | DISP_LAYER_FEAT_POS |
	    DISP_LAYER_FEAT_PRE_MULT_ALPHA | DISP_LAYER_FEAT_PIXEL_ALPHA |
	    DISP_LAYER_FEAT_COLOR_KEY | DISP_LAYER_FEAT_ZORDER,
...
static const enum __disp_layer_feat sun3iw1_disp_scaler_layer_feats[] = {
	/* DISP_SCREEN0 */
	DISP_LAYER_FEAT_SCALE | DISP_LAYER_FEAT_COLOR_ENHANCE |
	    DISP_LAYER_FEAT_DETAIL_ENHANCE,
};

static const unsigned int sun3iw1_disp_smart_backlight_support[] = {
	/* DISP_SCREEN0 */
	1,
};

static const unsigned int sun3iw1_disp_image_enhance_support[] = {
	/* DISP_SCREEN0 */
	1,
};

static const unsigned int sun3iw1_disp_capture_support[] = {
	/* DISP_SCREEN0 */
	1,
};

static const struct disp_features sun3iw1_disp_features = {
	.num_screens = 1,
	.num_layers = sun3iw1_disp_num_layers,
	.num_scalers = 1,
	.num_captures = 1,
	.num_smart_backlights = 1,
	.supported_output_types = sun3iw1_disp_supported_output_types,
	.layer_feats = sun3iw1_disp_layer_feats,
	.scaler_layer_feats = sun3iw1_disp_scaler_layer_feats,
	.smart_backlight_support = sun3iw1_disp_smart_backlight_support,
	.image_enhance_support = sun3iw1_disp_image_enhance_support,
	.capture_support = sun3iw1_disp_capture_support,
};
#endif
...
int disp_init_feat(void)
{
	...
	disp_current_features = &sun3iw1_disp_features;
#else
