...
enum disp_event_type {
	...
	/* (u32[2]:csc(0:rgb, 1:yuv for tv, 2:yuv for hdmi, */
	/* 3: yuv for sat),color_range) */
	DISP_EVENT_OUTPUT_CSC,
	...
	/* u32[2]: enable(0:dis,1:en); output_type */
	DISP_EVENT_OUTPUT_ENABLE = 0x40,
...
enum __disp_pixel_type_t {
	DISP_PIXEL_TYPE_RGB = 0x0,
	DISP_PIXEL_TYPE_YUV = 0x1,
};

struct disp_scaler_info {
	disp_fb_info in_fb;
	disp_fb_info out_fb;
};

struct __disp_layer_extra_info_t {
	u32 b_scaler_mode;
	u32 scaler_id;
};
...
struct disp_lcd {
	 ...
	 */
	 ...
	 s32 (*get_physical_size)(struct disp_lcd *lcd, u32 *width,
				  u32 *height);
	/* s32 (*set_timing)(struct disp_lcd *lcd, */
	/* disp_video_timing *timings); */
	 s32 (*get_timing)(struct disp_lcd *lcd, disp_video_timing *timings);
	 s32 (*get_input_csc)(struct disp_lcd *lcd,
	...
	disp_lcd_flow *(*get_close_flow)(struct disp_lcd *lcd);
	 ...
	 s32 (*set_panel_func)(struct disp_lcd *lcd,
	...
	/* direction: intput(0), output(1) */
	 s32 (*gpio_set_direction)(struct disp_lcd *lcd,
...
struct disp_manager {
	 ...
	 */
	 ...
	 s32 (*get_screen_size)(struct disp_manager *mgr,
...
struct disp_layer {
	 ...
	 */
	 ...
	 s32 (*set_info)(struct disp_layer *layer, disp_layer_info *info);
	 s32 (*get_info)(struct disp_layer *layer, disp_layer_info *info);
	 s32 (*is_support_caps)(struct disp_layer *layer,
				enum __disp_layer_feat caps);
...
struct disp_capture {
	...
	struct disp_manager *manager;
	 ...
	 s32 (*set_manager)(struct disp_capture *cptr,
			    struct disp_manager *mgr);
	 s32 (*capture_screen)(struct disp_capture *cptr,
			       disp_capture_para *para);
...
struct disp_cursor {
	 ...
	 */
	 ...
	 s32 (*set_manager)(struct disp_cursor *cursor,
			    struct disp_manager *mgr);
	...
	/* power manager */
	 ...
	 s32 (*set_palette)(struct disp_cursor *cursor,
...
#include "./lowlevel_v1x/disp_al.h"
