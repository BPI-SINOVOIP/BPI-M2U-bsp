...
#define SUN8IW6P1_ISP_FE_CFG_REG_OFF                  0x000
#define SUN8IW6P1_ISP_FE_CTRL_REG_OFF                 0x004
#define SUN8IW6P1_ISP_FE_INT_EN_REG_OFF               0x008
#define SUN8IW6P1_ISP_FE_INT_STA_REG_OFF              0x00c
#define SUN8IW6P1_ISP_DBG_OUTPUT_REG_OFF              0x018
#define SUN8IW6P1_ISP_LINE_INT_NUM_REG_OFF            0x018
#define SUN8IW6P1_ISP_ROT_OF_CFG_REG_OFF              0x01c

#define SUN8IW6P1_ISP_REG_LOAD_ADDR_REG_OFF           0x020
#define SUN8IW6P1_ISP_REG_SAVED_ADDR_REG_OFF          0x024
#define SUN8IW6P1_ISP_LUT_LENS_GAMMA_ADDR_REG_OFF     0x028
#define SUN8IW6P1_ISP_DRC_ADDR_REG_OFF                0x02c
#define SUN8IW6P1_ISP_STATISTICS_ADDR_REG_OFF         0x030
#define SUN8IW6P1_ISP_VER_CFG_REG_OFF                 0x034
#define SUN8IW6P1_ISP_SRAM_RW_OFFSET_REG_OFF          0x038
#define SUN8IW6P1_ISP_SRAM_RW_DATA_REG_OFF            0x03c
...
} SUN8IW6P1_ISP_FE_INT_STA_REG_t;
...
} SUN8IW6P1_ISP_DBG_OUTPUT_REG_t;
...
} SUN8IW6P1_ISP_LINE_INT_NUM_REG_t;
...
} SUN8IW6P1_ISP_ROT_OF_CFG_REG_t;
...
} SUN8IW6P1_ISP_REG_LOAD_ADDR_REG_t;
...
} SUN8IW6P1_ISP_REG_SAVED_ADDR_REG_t;
...
} SUN8IW6P1_ISP_LUT_LENS_GAMMA_ADDR_REG_t;
...
} SUN8IW6P1_ISP_STATISTICS_ADDR_REG_t;
