...
void mmc_change_dtb_for_dragonboard_test(int boot_card_no)
{
	int rval, ret = 0;
	int nodeoffset=0;
...
static void mmc_get_para_from_fex(int sdc_no)
{
	...
	if (sdc_no == 0)
	{
		...
		mmc_change_dtb_for_dragonboard_test(uboot_spare_head.boot_data.storage_type);
