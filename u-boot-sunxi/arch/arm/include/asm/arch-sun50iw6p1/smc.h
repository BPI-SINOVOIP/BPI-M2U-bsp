...
#define SMC_MASTER_BYPASS0_REG        (SUNXI_SMC_BASE + 0x0070)
#define SMC_MASTER_SECURITY0_REG      (SUNXI_SMC_BASE + 0x0080)
#define SMC_FAIL_ADDR_REG             (SUNXI_SMC_BASE + 0x0020)
#define SMC_FAIL_CTRL_REG             (SUNXI_SMC_BASE + 0x0024)
#define SMC_FAIL_ID_REG               (SUNXI_SMC_BASE + 0x0028)

#define SMC_INVER_EN_REG              (SUNXI_SMC_BASE + 0x0034)

#define SMC_MST_ATTRI_REG             (SUNXI_SMC_BASE + 0x0090)
